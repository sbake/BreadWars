            ...
            for (int i = 0; i < cardsToAdd.Length; i ++)
            {
                     for (int j = 0; j < cardsToAdd[i]; j++)
                     {
                         ...
                         switch (i)
                         {
                             ...
                             case 0: //0- Thief
                            Thief th = new Thief(cardTexts[i], empty, false);
                            library[cardsAdded] = th;
                            cardsAdded++;
                            break;
                             case 1: //1- Table flip
                            TableFlip tf = new TableFlip(cardTexts[i], empty, false);
                            library[cardsAdded] = tf;
                            cardsAdded++;
                            break;
                             case 2: //2- Stab
                            Stab s = new Stab(cardTexts[i], empty, false);
                            library[cardsAdded] = s;
                            cardsAdded++;
                            break;
                             case 3: //3- Glue Gun
                            GlueGun gg = new GlueGun(cardTexts[i], empty, false);
                            library[cardsAdded] = gg;
                            cardsAdded++;
                            break;
                             case 4: //4- Zombie
                             Zombie z = new Zombie(cardTexts[i], empty, false);
                            library[cardsAdded] = z;
                            cardsAdded++;
                            break;
                             case 5: //5- Jam
                            Jam ja = new Jam(cardTexts[i], empty, false);
                            library[cardsAdded] = ja;
                            cardsAdded++;
                            break;
                             case 6: //6- Save For Later
                            SaveForLater sl = new SaveForLater(cardTexts[i], empty, false);
                            library[cardsAdded] = sl;
                            cardsAdded++;
                            break;
                             case 7: //7- Octopus
                            Octopus o = new Octopus(cardTexts[i], empty, false);
                            library[cardsAdded] = o;
                            cardsAdded++;
                            break;
                             case 8: //8 Punch
                            Punch p = new Punch(cardTexts[i], empty, false);
                            library[cardsAdded] = p;
                            cardsAdded++;
                            break;
                             case 9: //poison
                            Poison po = new Poison(cardTexts[i], empty, false);
                            library[cardsAdded] = po;
                            cardsAdded++;
                            break;
                             case 10: //faire bread
                            FaireBread fb = new FaireBread(cardTexts[i], empty, false);
                            library[cardsAdded] = fb;
                            cardsAdded++;
                            break;
                             case 11: //tazer
                            Tazer ta = new Tazer(cardTexts[i], empty, false);
                            library[cardsAdded] = ta;
                            cardsAdded++;
                            break;
                             case 12: //hand switch
                            HandSwitch hs = new HandSwitch(cardTexts[i], empty, false);
                            library[cardsAdded] = hs;
                            cardsAdded++;
                            break;
                             case 13: //telepathy
                            Telepathy te = new Telepathy(cardTexts[i], empty, false);
                            library[cardsAdded] = te;
                            cardsAdded++;
                            break;
                             case 14: //block
                            Block bl = new Block(cardTexts[i], empty, false);
                            library[cardsAdded] = bl;
                            cardsAdded++;
                            break;
                             case 15: //whale
                            Whale wh = new Whale(cardTexts[i], empty, false);
                            library[cardsAdded] = wh;
                            cardsAdded++;
                            break;
                             case 16: //banker
                            Banker b = new Banker(cardTexts[i], empty, false);
                            library[cardsAdded] = b;
                            cardsAdded++;
                            break;
                             case 17: //fire
                            Fire fi = new Fire(cardTexts[i], empty, false);
                            library[cardsAdded] = fi;
                            cardsAdded++;
                            break;
                             case 18: //unicorn
                            Unicorn u = new Unicorn(cardTexts[i], empty, false);
                            library[cardsAdded] = u;
                            cardsAdded++;
                            break;
                             case 19: //confetti
                            Confetti c = new Confetti(cardTexts[i], empty, false);
                            library[cardsAdded] = c;
                            cardsAdded++;
                            break;
                             case 20: //numbject to change
                            NumjectToChange nj = new NumjectToChange(cardTexts[i], empty, false);
